...
import { Box, Button, TextField, Typography, Alert, CircularProgress, Tooltip } from "@mui/material";
  ...
  return (
    ...
    >
      <Box 
        ...
        <Typography variant="h4" sx={{ mb: 1, textAlign: "center", color: theme.palette.primary.main, fontWeight: "bold" }}>
          Вход в аккаунт
        </Typography>
        ...
        <Typography variant="body1" sx={{ textAlign: "center", mt: 1, color: theme.palette.text.secondary }}>
          Нет аккаунта?{" "}
